...
public class NumericalAggregation {
	...
	public <T extends Number> List<AnalyzerResult<T>> analyze(
			List<DocGraph> docGraps, DocGraphMeasureFunction<T> measure,
			DocGraphFilterFunction f) {
	...
	public <T extends Number> List<AnalyzerResult<T>> analyze(
			List<DocGraph> docGraphs, DocGraphMeasureFunction<T> measure) {
